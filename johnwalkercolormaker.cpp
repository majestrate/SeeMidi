...
JohnWalkerColorMaker::JohnWalkerColorMaker(int it, double &ir,double &ig,double &ib)
{
...
void JohnWalkerColorMaker::upvp_to_xy(double up, double vp, double *xc, double *yc)
{
...
void JohnWalkerColorMaker::xy_to_upvp(double xc, double yc, double *up, double *vp)
{
...
void JohnWalkerColorMaker::xyz_to_rgb(struct colourSystem *cs,
...
int JohnWalkerColorMaker::inside_gamut(double r, double g, double b)
{
    return (r >= 0) && (g >= 0) && (b >= 0);
}
...
int JohnWalkerColorMaker::constrain_rgb(double *r, double *g, double *b)
{
    double w;
...
void JohnWalkerColorMaker::gamma_correct(const struct colourSystem *cs, double *c)
{
    double gamma;
...
void JohnWalkerColorMaker::gamma_correct_rgb(const struct colourSystem *cs, double *r, double *g, double *b)
{
    gamma_correct(cs, r);
    gamma_correct(cs, g);
    gamma_correct(cs, b);
...
void JohnWalkerColorMaker::norm_rgb(double *r, double *g, double *b)
{
...
void JohnWalkerColorMaker::spectrum_to_xyz(
...
double bbTemp = 5000;                 /* Hidden temperature argument
                                         to BB_SPECTRUM. */
double JohnWalkerColorMaker::bb_spectrum(double wavelength)
{
